            ...
            <div class="p-6">
                <div class="mb-6 border-b pb-4">
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        Update the information for {{ $subject->name }}.
                    </p>
                </div>
                ...
                <form method="POST" action="{{ route('subjects.update', $subject) }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="credit" id="credit" value="{{ old('credit', $subject->credit) }}" 
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea name="description" id="description" rows="4" 
                                ...
                                placeholder="Enter a description of the subject">{{ old('description', $subject->description) }}</textarea>
                            @error('description')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
